...
6. If you did everything correct, https://justeat.github.io/parterapi-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://justeat.github.io/parterapi-docs/
- Look full spec:
    + JSON https://justeat.github.io/parterapi-docs/swagger.json
    + YAML https://justeat.github.io/parterapi-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://justeat.github.io/parterapi-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://justeat.github.io/parterapi-docs/ with url from the message: `Server started <url>`
